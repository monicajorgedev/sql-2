...
UPDATE usuarios SET id_rol = 1 WHERE id_usuario = 15;
...
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (4, 11, 15);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (12);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (16);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (14);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (5,7);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (13,9);
UPDATE usuarios SET id_categoria = 10 WHERE id_usuario IN (8,19);
